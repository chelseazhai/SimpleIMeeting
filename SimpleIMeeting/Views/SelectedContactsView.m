...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _mSelectedContactsTableView = [[UITableView alloc] initWithFrame:CGRectMake(self.bounds.origin.x, self.bounds.origin.y + _selectedContactsHeadTipView.height, self.bounds.size.width, self.bounds.size.height - _selectedContactsHeadTipView.height)];
